const data = {
  challenges: [
    {
      name: '20 ORDENADORES PARA LA ESCOLA MIL-LENARI (CARDEDEU)',
      ...
      category: 'Children',
      image: 'https://images.pexels.com/photos/1815257/pexels-photo-1815257.jpeg?cs=srgb&dl=pexels-samer-daboul-1815257.jpg&fm=jpg',
      target: 2000,
      collected: 100,
      participants: 3,
      days: 30,
    ...
    {
      name: '500 MANTAS PARA AYUDA A PERSONAS SIN TECHO',
