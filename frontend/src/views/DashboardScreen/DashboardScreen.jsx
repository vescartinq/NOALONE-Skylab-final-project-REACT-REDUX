    ...
    <div className="listScreen-mainContainer">
      ...
      <div className="logged-container">
        <div className="logged-container_box">
          ...
          <Button size="large" type="button" variant="contained" color="primary">AYUDA A TU COMUNIDAD</Button>
        </div>
        <div div className="logged-container_box">
          ...
          <Button size="large" type="button" variant="contained" color="primary">HAZ UNA DONACIÓN</Button>
        </div>
      </div>
      {loading ? (
      ...
      <div className="list-route">
        <Link to="/challenges">LISTADO DE TODOS LOS CHALLENGES EN ACTIVO</Link>
      </div>
    </div>
